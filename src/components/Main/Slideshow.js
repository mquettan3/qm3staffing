                    ...
                    <div id="slider-banner-fullwidth" className="slider-banner-fullwidth rev_slider" data-version="5.0">
                      <ul className="slides">
                        ...
                        <div className="tp-caption medium_white"
                          ...
                          <a href="#" className="btn radius-50 btn-dark btn-animated" style={{marginRight: "30px"}}>For Job Seekers <i className="fa fa-arrow-right"></i></a>
                          <a href="#" className="btn radius-50 btn-dark btn-animated" style={{marginBottom: "10px"}}>For Employers <i className="fa fa-arrow-right"></i></a>
                        </div>
