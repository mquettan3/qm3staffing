          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6 order-lg-1">
                ...
                <p>There is no talent we cannot find and no opportunity we cannot locate.  We aim to be the bridge between talent and opportunity.  We do <b>NOT</b> simply provide anyone with a heartbeat to any position with any companay willing to hire.  We make the difficult choices between what is convenient and what is <span className="text-default"><b>Right</b></span>!  We unite you with the <span className="text-default"><b>Right</b></span> talent or the <span className="text-default"><b>Right</b></span> opportunity; not just anybody, and not just any job.</p>
                <ul>
